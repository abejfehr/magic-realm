...
public class LindenWoods extends HexTile implements Serializable {
	
	private static final long serialVersionUID = -8687319945983797013L;
	...
	public LindenWoods(int angle) {
		...
		super(angle, "lindenwoods1.gif", "lindenwoods-e1.gif");
	...
	public void init() {
		...
		// Define the clearings
		Clearing ec2 = new Clearing(2, 251, 278);
		Clearing ec4 = new Clearing(4, 134, 150);
		Clearing ec5 = new Clearing(5, 301, 123);
