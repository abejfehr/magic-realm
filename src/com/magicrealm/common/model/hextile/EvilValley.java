...
public class EvilValley extends HexTile implements Serializable {
	...
	public EvilValley(int angle) {
		...
		super(angle, "evilvalley1.gif", "evilvalley-e1.gif");
	...
	private void init() {
		...
		// Define the clearings
		Clearing ec1 = new Clearing(1, 133, 285);
		Clearing ec2 = new Clearing(2, 132, 150);
		Clearing ec4 = new Clearing(4, 312, 101);
