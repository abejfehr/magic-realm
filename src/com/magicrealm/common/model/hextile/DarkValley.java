...
public class DarkValley extends HexTile implements Serializable {
	
	private static final long serialVersionUID = 3856379662911649772L;
	...
	public DarkValley(int angle) {
		...
		super(angle, "darkvalley1.gif", "darkvalley-e1.gif");
	...
	private void init() {
		...
		e5.adjacencyListByNormalPath.add(c4);
		c4.adjacencyListByNormalPath.add(e5);
		...
		// Define the clearings
		Clearing ec1 = new Clearing(1, 365, 151);
		Clearing ec2 = new Clearing(2, 253, 84);
		Clearing ec4 = new Clearing(4, 185, 250);
		Clearing ec5 = new Clearing(5, 363, 279);
