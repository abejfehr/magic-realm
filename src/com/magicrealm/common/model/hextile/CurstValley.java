...
public class CurstValley extends HexTile implements Serializable {
	
	private static final long serialVersionUID = -2217084817358505902L;
	...
	public CurstValley(int angle) {
		...
		super(angle, "curstvalley1.gif", "curstvalley-e1.gif");
	...
	private void init() {
		...
		// Define the clearings
		Clearing ec1 = new Clearing(1, 250, 83);
		Clearing ec2 = new Clearing(2, 134, 147);
		Clearing ec4 = new Clearing(4, 246, 285);
		Clearing ec5 = new Clearing(5, 355, 145);
