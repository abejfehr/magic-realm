...
public class MapleWoods extends HexTile implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 3981166391014403125L;
	...
	public MapleWoods(int angle) {
		...
		super(angle, "maplewoods1.gif", "maplewoods-e1.gif");
	...
	private void init() {
		...
		// Define their paths
		c2.adjacencyListByHiddenPath.add(c4);
		c4.adjacencyListByHiddenPath.add(c2);
		...
		// Define the clearings
		Clearing ec2 = new Clearing(2, 317, 117);
		Clearing ec4 = new Clearing(4, 371, 274);
		Clearing ec5 = new Clearing(5, 143, 216);
