...
public class NutWoods extends HexTile implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -3192155406322948088L;
	...
	public NutWoods(int angle) {
		...
		super(angle, "nutwoods1.gif", "nutwoods-e1.gif");
	...
	private void init() {
		...
		Clearing ec2 = new Clearing(2, 185, 106);
		Clearing ec4 = new Clearing(4, 352, 137);
		Clearing ec5 = new Clearing(5, 247, 282);
