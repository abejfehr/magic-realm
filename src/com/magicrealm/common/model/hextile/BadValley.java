...
public class BadValley extends HexTile implements Serializable {
	
	private static final long serialVersionUID = 45538766972506741L;
	...
	public BadValley(int angle) {
		...
		super(angle, "badvalley1.gif", "badvalley-e1.gif");
	...
	private void init() {
		...
		// Define the clearings
		Clearing ec1 = new Clearing(1, 302, 313);
		Clearing ec2 = new Clearing(2, 135, 281);
		Clearing ec4 = new Clearing(4, 181, 104);
		Clearing ec5 = new Clearing(5, 364, 150);
